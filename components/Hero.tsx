...
export const Hero: React.FC<HeroProps> = ({ onImageSelected, isLoading }) => {
  return (
    <div className="relative pt-12 pb-16 md:pt-24 md:pb-32 overflow-hidden w-full">
      
      {/* Hero Content */}
      <div className="relative w-full max-w-[1400px] mx-auto px-4 sm:px-6 flex flex-col items-center text-center z-10">
        
        {/* Top Trust Badge */}
        <div className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-md border border-slate-200/60 rounded-full px-4 py-1.5 shadow-[0_4px_10px_rgba(0,0,0,0.03)] mb-10 animate-fade-in-up cursor-default hover:border-blue-200 transition-colors duration-300">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter text-slate-900 mb-8 w-full animate-fade-in-up delay-100 leading-[1] px-2 drop-shadow-sm">
        ...
        <p className="text-lg sm:text-xl text-slate-500 mb-14 max-w-2xl mx-auto leading-relaxed font-medium animate-fade-in-up delay-200 px-4">
        ...
        <div className="w-full max-w-2xl mx-auto animate-fade-in-up delay-300 mb-16 relative z-20 px-4 sm:px-0">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 animate-fade-in-up delay-500 w-full px-4">
